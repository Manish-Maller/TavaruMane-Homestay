...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>TavaruMane Homestay</p>
				<p>Tarlghatta,<br>Sirsi,<br>Karnataka.</p>
				<p>(+91) 8217889327</p>
			</address>
			<span><img alt="" src="assets/img/tavaru.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@tavarumane.com || Web :- www.tavarumane.com || Phone :- +91 821 788 9327 </p>
			</div>
		</aside>
	</body>
</html>
